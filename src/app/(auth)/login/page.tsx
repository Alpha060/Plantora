...
import type { LoginFormData, OtpFormData } from "@/lib/validations";
    ...
    try {
      ...
      if (authData.user) {
        ...
        if (profile?.role === "admin") {
          ...
          router.push(ROUTES.RIDER.DASHBOARD);
        } else {
  ...
  return (
    <div className="w-full bg-surface-lowest">
      ...
      <div className="flex items-center gap-8 mb-8 border-b border-surface-container-high relative">
        ...
        <div className="relative pb-3">
          <Link href="/register" className="text-on-surface-variant hover:text-on-surface transition-colors">
            Register
          </Link>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="space-y-2 mb-8">
            ...
            <p className="text-on-surface-variant text-sm">
              Enter your details to access your botanical collection.
            </p>
          </div>
        ...
        <div className="space-y-6">
          <div className="space-y-2 mb-8">
            ...
            <p className="text-on-surface-variant text-sm flex items-center gap-2">
              Code sent to <strong className="text-on-surface">+91 {phone}</strong>
              <button
                type="button"
