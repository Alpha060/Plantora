        ...
        return (
          <Badge
            ...
            className={`px-3 py-1 rounded-full font-medium uppercase tracking-wider text-[10px]
              ${
                s === "placed" ? "bg-teal-100 text-teal-700 border-teal-200" :
                s === "confirmed" ? "bg-blue-100 text-blue-700 border-blue-200" :
                s === "packed" ? "bg-indigo-100 text-indigo-700 border-indigo-200" :
                s === "rider_assigned" ? "bg-yellow-100 text-yellow-700 border-yellow-200" :
                s === "picked_up" ? "bg-orange-100 text-orange-700 border-orange-200" :
